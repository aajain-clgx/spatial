...
var Logger = function(config) {
  ...
  var _logFilePath = config.logFilePath || '';
  var _appName = config.appName || 'UNKNOWN'; 
  var _machineName = config.machineName || 'UNKNOWN';
  var  _fileLevel = LoggingLevels.get(config.fileLevel) || LoggingLevels.OFF;
  var _emailLevel = LoggingLevels.get(config.emailLevel) || LoggingLevels.OFF;
  var _emailSender = config.emailSender || 'NOBODY@NOWHERE.COM';
  var _emailRecipient = config.emailRecipient || 'NOBODY@NOWHERE.COM';
  var _smtpServer = config.smtpServer || '';
